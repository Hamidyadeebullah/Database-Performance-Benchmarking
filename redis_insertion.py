...
csv_file_paths = ['D:\\Database mod b project\\Data_3ak.csv', 'D:\\Database mod b project\\Data_3bk.csv', 'D:\\Database mod b project\\Data_3ck.csv',
                  'D:\\Database mod b project\\overall_data.csv']
